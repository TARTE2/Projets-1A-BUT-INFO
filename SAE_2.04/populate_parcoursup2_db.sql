...
--Peuplement de parcoursup2 --

-- Supprime toute les valeurs de toutes les tables --
TRUNCATE _academie,_region,_departement,_commune,_etablissement,_filiere,_formation,_session,_mention_bac,_type_bac,_admissions_generalites,_admissions_selon_type_neo_bac,_effectif_selon_mention,_rang_dernier_appele_selon_regroupement,_regroupement;

-- Insérer les années sans doublons --
INSERT INTO _session
(
  session_annee
)
SELECT DISTINCT import_data.session_annee
FROM import_data;

-- Insérer les régions sans doublons --
INSERT INTO _region
(
  region_nom
)
SELECT DISTINCT import_data.region_nom
FROM import_data;

--Insertion valeur dans _department --
...
-- Insertion valeur dans _commune --
...
-- Insertion valeur dans _etablissement --
...
SELECT DISTINCT etablissement_code_uai,
       ...
       etablissement_statut
FROM import_data;
-- Insertion valeur dans _acadmie --
...
-- Insertion valeur dans _filiere --
...
-- Insertion valeur dans _formation --
...
-- Insertion valeur dans _mention_bac--
...
(
  'Très bien avec félicitation du jury'
);
-- Insertion valeur dans _type_bac --
...
-- Insertion valeur dans _admissions_selon_type_neo_bac --
...
SELECT cod_aff_form,
       session_annee,
       type_bac,
       COALESCE(effectif_admis_neo_bac_type_general,effectif_admis_neo_bac_type_techno,effectif_admis_neo_bac_type_pro,effectif_admis_neo_bac_type_autres)
FROM import_data,
     _type_bac;

-- Insertion valeur dans _admissions_generalites --
...
-- Insertion valeur dans _effectif_selon_mention --
TRUNCATE _effectif_selon_mention;
...
SELECT cod_aff_form,
       ...
       libelle_mention,
       effectif_admis_neo_bac_selon_mention
FROM (SELECT cod_aff_form,
             session_annee,
             'Sans information' AS libelle_mention,
             effectif_admis_neo_bac_selon_mention_type_mention_sans_info AS effectif_admis_neo_bac_selon_mention
      FROM import_data
      UNION ALL
      SELECT cod_aff_form,
             session_annee,
             'Sans mention' AS libelle_mention,
             effectif_admis_neo_bac_selon_mention_type_mention_sans_mention AS effectif_admis_neo_bac_selon_mention
      FROM import_data
      UNION ALL
      SELECT cod_aff_form,
             session_annee,
             'Assez bien' AS libelle_mention,
             effectif_admis_neo_bac_selon_mention_type_mention_assez_bien AS effectif_admis_neo_bac_selon_mention
      FROM import_data
      UNION ALL
      SELECT cod_aff_form,
             session_annee,
             'Bien' AS libelle_mention,
             effectif_admis_neo_bac_selon_mention_type_mention_bien AS effectif_admis_neo_bac_selon_mention
      FROM import_data
      UNION ALL
      SELECT cod_aff_form,
             session_annee,
             'Très bien' AS libelle_mention,
             effectif_admis_neo_bac_selon_mention_type_mention_tres_bien AS effectif_admis_neo_bac_selon_mention
      FROM import_data
      UNION ALL
      SELECT cod_aff_form,
             session_annee,
             'Très bien avec félicitation du jury' AS libelle_mention,
             effectif_admis_neo_bac_selon_mention_type_mention_tres_bien_fel AS effectif_admis_neo_bac_selon_mention
      FROM import_data) AS subquery;

-- Insertion valeur dans _regroupement --
...
-- Insertion valeur dans _rang_dernier_appele_selon_regroupement --
